var testusernum = 3;
            ...
            for(x=6; x>=1;x=x/2){ //6 rounds in Round of 64  // for(x=0;x<6;x+
        ...
        console.log(winners);
            ...
            for(y=0; y<numofsongsleft;y+=2){ //Counting the songs in each round that we go through
        ...
        while(usersongs2 == usersongs1 ){ //Makes sure the same user isn't going against themselves //&& usersongs1!=-1 && usersongs2 !=-1
            ...
            console.log("Lets select new songs");
