...
### Update:
- Added checks for odd number of total songs OR blanks on required fields
- Added coin flip system (More edits to UI coming)
- Should we allow optional addition of extra songs to users (Shouldn't be needed)
### Notes
